...
export const accountApi = {
  ...
  getOrderDetail: (token: string, orderNumber: string) =>
    api.get<AccountOrder>(`/orders/${orderNumber}`, { token }).then(toOrderDetail),
  ...
  getAddresses: (token: string) =>
    api.get<Address[]>('/addresses', { token }),
  ...
  getProductReviews: (
    ...
    api.get<ApiPaginatedResponse<ProductReview>>(`/reviews/product/${productId}`, {
